...
class PortfolioOptimizer:
    ...
    def optimize(self, n_games=5, n_candidates=300000, method='pair_covering'):
...
def compare_trincas(contests, trinca1, trinca2, n_games=5, n_candidates=300000, method='pair_covering', excluded=None):
...
def main():
    ...
    while True:
        ...
        if op == '1':
            ...
            portfolio = opt.optimize(5, 300000, method=method)
